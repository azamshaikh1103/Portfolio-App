export const Navbar = () => {
  return (
    <div className=" navbar top-7 fixed py-5 inset-x-0 w-auto sm:px-12 rounded-xl shadow shadow-gray-800 md:mx-10  lg:mx-28 h-auto backdrop-blur-xl  bg-gradient-to-r/ from-[#000319] to-[#161828] outline outline-1 outline-[#131728] flex justify-center sm:justify-between ">
