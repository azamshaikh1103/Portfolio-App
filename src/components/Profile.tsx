    ...
    <>
      <div className=" mx-4 my-4 h-32 bg-gradient-to-r from-[#070a1f] via-[#191c28] rounded-xl outline outline-1 outline-[#131728] flex justify-center items-center">
        ...
        <div className=" w-3/4 mr-5">
            <div>logoTitle</div>
            <div className=" text-xs md:text-base">Lorem ipsum, dolor sit amet consectetur adipisicing elit. In ratione velit est qui repudiandae voluptate necessitatibus incidunt ipsum </div>
        </div>
      </div>
    </>
  );
